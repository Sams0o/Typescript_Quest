...
On utlise les mot clés "import" et "export" pour diviser notre programme en différents fichiers. Il faut vérifier que tous les dossiers que l'on a diviser soit tous regrouper dans le même fichier JS.
```
Exemple :
export class Person {
  name: string;
